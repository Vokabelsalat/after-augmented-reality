...
export function IntroScreen() {
  ...
  return (
    <main className="film-grain relative flex min-h-dvh flex-col overflow-hidden bg-[#050505] px-6 text-[#F3F0E8]">
      <div className="safe-top flex items-center justify-between text-[10px] tracking-[0.24em] text-white/45 uppercase">
      ...
      <div className="flex flex-1 flex-col justify-center pb-[10vh]">
        <p className="mb-4 text-xs tracking-[0.26em] text-white/50 uppercase">
      ...
      <div className="safe-bottom relative z-10 pb-6">
        ...
        <p className="mt-4 text-center text-[10px] leading-4 tracking-[0.12em] text-white/35 uppercase">
